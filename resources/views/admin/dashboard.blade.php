        ...
        <div class="data_grid">
            ...
            <div class="card bar_graph">
                <div class="product card">
                    <div class="productChart" data-names="{{ $category->implode('title', '-') }}"
                        data-values="{{ $category->implode('products_count', '-') }}">
            ...
            <div class="card notify">
                ...
                <div>
                    <h1>Ksh.{{ $order->grand_total }}</h1>
                    <p>{{$order->postal_code}} | {{$order->short_name}}</p>
                </div>
                @empty
